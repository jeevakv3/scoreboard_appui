...
class _ListItemState extends State<ListItem>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: widget.title == 'Upcoming Events'
          ? ListView.builder(
              itemCount: 3,
          ...
          : widget.title == 'Stats'
              ...
              : widget.title == 'Recent performance'
                  ...
                  : widget.title == 'Places To Eat'
                      ? GridView.builder(
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          padding: const EdgeInsets.all(
                              2), // Padding around the grid
                          itemCount:
                              image.length, // The number of items in the grid
                          gridDelegate:
